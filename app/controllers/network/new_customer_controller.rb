...
class Network::NewCustomerController < Admin::AdminController
  ...
  def new_customer_params; params.require(:network_new_customer_application).permit(:number, :rs_tin, :mobile, :email, :address, :work_address, :address_code, :bank_code, :bank_account, :need_resolution, :voltage, :power) end
